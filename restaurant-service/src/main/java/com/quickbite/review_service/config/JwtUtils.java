 ...
 *
 * jwt.secret MUST match auth-service exactly (raw bytes, same as restaurant-service).
 * review-service never generates tokens — only validates.
 *
 * Claims:
 *  - sub    → email (String)
 *  - userId → Integer (principal in SecurityContext)
...
public class JwtUtils {
    ...
    /** Returns userId (Integer) — used as principal in SecurityContext */
